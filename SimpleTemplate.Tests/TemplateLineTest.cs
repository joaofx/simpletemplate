namespace SimpleTemplate.Tests
{
    ...
    public class TemplateLineTest
    {
        ...
        {
            var line = new TemplateLine("My name is ${name}").Parse();
        ...
        {
            var line = new TemplateLine("My name is ${name} and im ${age} years old").Parse();
            line.Variables.Contains("name").ShouldBeTrue();
        ...
        {
            var line = new TemplateLine("My name is ${name} and ${age years old").Parse();
        }

        [Test]
        public void Should_not_parse_if_not_exists_variables()
        {
            var line = new TemplateLine("Dont exists variables here").Parse();
        ...
        {
            var line = new TemplateLine("${foreach childrens}").Parse();
            line.Variables.ShouldBeEmpty();
        ...
        {
            var line = new TemplateLine("${end foreach}").Parse();
            line.Variables.ShouldBeEmpty();
